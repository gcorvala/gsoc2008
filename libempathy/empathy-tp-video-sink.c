/*
 * videosink.c - Source for EmpathyTpVideoSink
...
G_DEFINE_ABSTRACT_TYPE (EmpathyTpVideoSink, empathy_tp_video_sink,
    G_TYPE_OBJECT);

struct _EmpathyTpVideoSinkPrivate
{
  GstElement *sink;
  GtkWidget *plug;
...
static void
empathy_tp_video_sink_init (EmpathyTpVideoSink *self)
{
  EmpathyTpVideoSinkPrivate *priv = G_TYPE_INSTANCE_GET_PRIVATE (self,
      EMPATHY_TP_TYPE_VIDEO_SINK, EmpathyTpVideoSinkPrivate);
...
static GObject *
empathy_tp_video_sink_constructor (GType type,
    guint n_props,
    GObjectConstructParam *props)
{
  GObject *obj;
  EmpathyTpVideoSink *self = NULL;

  obj = G_OBJECT_CLASS (empathy_tp_video_sink_parent_class)->constructor (type, n_props, props);

  self = (EmpathyTpVideoSink *) obj;
...
static void
empathy_tp_video_sink_dispose (GObject *object)
{
  EmpathyTpVideoSink *self = EMPATHY_TP_VIDEO_SINK (object);
  ...
  if (G_OBJECT_CLASS (empathy_tp_video_sink_parent_class)->dispose)
    G_OBJECT_CLASS (empathy_tp_video_sink_parent_class)->dispose (
        object);
}
...
static void
empathy_tp_video_sink_set_property  (GObject *object,
    guint property_id,
    const GValue *value,
    GParamSpec *pspec)
{
...
static void
empathy_tp_video_sink_get_property  (GObject *object,
    guint property_id,
    GValue *value,
    GParamSpec *pspec)
{
...
static void
empathy_tp_video_sink_class_init (EmpathyTpVideoSinkClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);
  GParamSpec *param_spec;

  g_type_class_add_private (klass, sizeof (EmpathyTpVideoSinkPrivate));
  object_class->dispose = empathy_tp_video_sink_dispose;
  object_class->constructor = empathy_tp_video_sink_constructor;
  object_class->set_property = empathy_tp_video_sink_set_property;
  object_class->get_property = empathy_tp_video_sink_get_property;
